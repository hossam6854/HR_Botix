    ...
    <div style={{padding:"15px", textAlign:"left",}}>
        <div>
          ...
          <div className="col-lg-9 pt-50 ">
                <div className='row '>
                  <div className='col-sm-2'>
                      <label htmlFor="inputAddress1" className="col-form-label">Address1</label>
                  </div>
                  <div className='col-sm-10 col-12'>
              ...
              <div className="col-lg-9 pt-50 ">
                <div className='row '>
                  <div className='col-sm-2'>
                    <label htmlFor="inputAddress2" className="col-form-label">Address2</label>
                  </div>
                  <div className='col-sm-10 col-12'>
          ...
          <div className="col-lg-9 pt-50 ">
                <div className='row '>
                  <div className='col-sm-2'>
                    <label htmlFor="pin" className="col-form-label">Pincode</label>
                  </div>
                  <div className='col-sm-10  col-12'>
              ...
              <div className="col-lg-8 col-12 pt-5 px-4">
                <div className='row '>
                  <div className='col-lg-1 col-sm-2 col-12'>
                    <label htmlFor="Textarea" className="col-form-label">Objective</label>
                  </div>
        ...
        <BottomNavigation prevPagePath='/homeee' nextPagePath='/detailsfillingpage/workex' isFormValid={props.isFormValid}/>
