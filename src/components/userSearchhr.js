...
<button onClick={() => navigate('/farewell')} style={{ margin: '20px', marginLeft: '1400px', padding: '10px 20px', fontSize: '16px', borderRadius: '10px', backgroundColor: '#d08989', color: 'white', border: 'none', cursor: 'pointer' }}>Goodbye</button>
