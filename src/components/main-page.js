...
import myImage1 from './assets/images/hoss.jpg';
import myImage2 from './assets/images/sayed.jpg';
import myImage3 from './assets/images/kero.jpg';
import myImage4 from './assets/images/1001.jpg';
import myImage5 from './assets/images/mooo.jpg';
import myImage6 from './assets/images/Robert.jpg';
import myImage7 from './assets/images/keero.jpg';
...
import "./cv-template/css/vendor.css"
  ...
  function Mainpage() {
    ...
    const [activeMenuItem, setActiveMenuItem] = useState('Home'); // Initialize the active menu item
      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
            ...
            <li class="scroll-to-section"><div class="main-red-button-hover"><a href="/log">Sign up Now</a></div></li>
          </ul>
        </nav>
      </div>
    </div>
